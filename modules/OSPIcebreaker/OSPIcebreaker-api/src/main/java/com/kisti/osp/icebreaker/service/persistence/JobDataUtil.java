...
public class JobDataUtil {
	...
	*/
	...
	static {
		...
		ServiceTracker<JobDataPersistence, JobDataPersistence> serviceTracker = new ServiceTracker<JobDataPersistence, JobDataPersistence>(bundle.getBundleContext(),
				JobDataPersistence.class, null);
