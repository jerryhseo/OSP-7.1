...
import com.kisti.osp.icebreaker.model.JobDataSoap;
...
public class JobDataModelImpl extends BaseModelImpl<JobData>
	 ...
	 */
	public static JobData toModel(JobDataSoap soapModel) {
		if (soapModel == null) {
			return null;
		}

		JobData model = new JobDataImpl();
	 ...
	 */
	public static List<JobData> toModels(JobDataSoap[] soapModels) {
		if (soapModels == null) {
			return null;
		}

		List<JobData> models = new ArrayList<JobData>(soapModels.length);

		for (JobDataSoap soapModel : soapModels) {
	...
	private static final Class<?>[] _escapedModelInterfaces = new Class[] {
			JobData.class, ModelWrapper.class
		};
	private long _jobId;
