<%@page import="com.osp.icebreaker.scheduler.manager.constants.OSPSchedulerManagerConstants"%>
...
<portlet:renderURL var="addURL">
	<portlet:param name="mvcRenderCommandName" value="<%= OSPSchedulerManagerConstants.MVC_RENDER_EDIT_SCHEDULER %>"></portlet:param>
	<portlet:param name="command" value="ADD"></portlet:param>
	<portlet:param name="backURL" value="<%=currentURL%>"></portlet:param>
</portlet:renderURL>

<a href="<%=addURL%>" class="btn btn-default btn-sm" role="button"><liferay-ui:message key="add"></liferay-ui:message></a>
...
<liferay-ui:search-container 
	...
	<liferay-ui:search-container-row className="com.kisti.osp.icebreaker.model.OSPSchedulerEntry" modelVar="scheduler" keyProperty="schedulerEntryId" >
		...
		<portlet:renderURL var="rowURL">
			...
			<portlet:param name="mvcRenderCommandName" value="/jsps/full_content"/>
		</portlet:renderURL>
		...
		<liferay-ui:icon-menu>
			<c:if test="<%= SchedulerPermission.contains(permissionChecker, scheduler.getSchedulerEntryId(), ActionKeys.UPDATE) %>">
				<portlet:renderURL var="editURL">
					...
					<portlet:param name="mvcRenderCommandName" value="/jsps/edit_scheduler"></portlet:param>
					<portlet:param name="backURL" value="<%=currentURL %>"></portlet:param>
...
AUI().use(
		...
		function(A) {
			...
			A.on( 'domready',
					function(){
						Liferay.fire('ospSchedulerManagerReady');
					}
			);
		}
 );
