...
@Component(
	...
	property = {
        ...
        "mvc.command.name="+OSPSchedulerManagerConstants.MVC_RENDER_FULL_CONTENT_SCHEDULER
    },
...
public class FullContentOSPSchedulerRenderCommand implements MVCRenderCommand {
	...
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		...
		RequestDispatcher requestDispatcher =
            this.servletContext.getRequestDispatcher(OSPSchedulerManagerConstants.MVC_RENDER_FULL_CONTENT_SCHEDULER+".jsp");
