...
import com.test.service.builder.model.FooModel;
import com.test.service.builder.model.FooSoap;
...
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.test.service.builder.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.test.service.builder.model.Foo"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.test.service.builder.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.test.service.builder.model.Foo"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.test.service.builder.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.test.service.builder.model.Foo"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.test.service.builder.service.util.ServiceProps.get(
				"lock.expiration.time.com.test.service.builder.model.Foo"));
	...
	public String toXmlString() {
		...
		sb.append("com.test.service.builder.model.Foo");
