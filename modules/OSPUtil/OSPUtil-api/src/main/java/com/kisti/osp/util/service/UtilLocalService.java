...
/**
 * Provides the local service interface for Util. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UtilLocalServiceUtil
...
public interface UtilLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UtilLocalServiceUtil} to access the util local service. Add custom service methods to {@link com.kisti.osp.util.service.impl.UtilLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
