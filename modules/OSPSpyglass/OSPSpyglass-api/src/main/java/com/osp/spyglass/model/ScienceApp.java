 ...
 * @author Jerry H. Seo
 * @see ScienceAppModel
 * @see com.osp.spyglass.model.impl.ScienceAppImpl
 * @see com.osp.spyglass.model.impl.ScienceAppModelImpl
 * @generated
 */
@ImplementationClassName("com.osp.spyglass.model.impl.ScienceAppImpl")
@ProviderType
public interface ScienceApp extends ScienceAppModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link com.osp.spyglass.model.impl.ScienceAppImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
