 ...
 * @author Jerry H. Seo
 * @see LayoutModel
 * @see com.osp.spyglass.model.impl.LayoutImpl
 * @see com.osp.spyglass.model.impl.LayoutModelImpl
 * @generated
 */
@ImplementationClassName("com.osp.spyglass.model.impl.LayoutImpl")
@ProviderType
public interface Layout extends LayoutModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link com.osp.spyglass.model.impl.LayoutImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
