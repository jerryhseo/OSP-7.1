 ...
 * @see com.osp.spyglass.service.persistence.impl.LayoutPersistenceImpl
 * @generated
 */
@ProviderType
public class LayoutUtil {
	...
	*/
	public static Layout remove(long scienceAppId)
		throws com.osp.spyglass.exception.NoSuchLayoutException {
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(LayoutPersistence.class);

		ServiceTracker<LayoutPersistence, LayoutPersistence> serviceTracker = new ServiceTracker<LayoutPersistence, LayoutPersistence>(bundle.getBundleContext(),
				LayoutPersistence.class, null);
