...
/**
 * This class is used by SOAP remote services, specifically {@link com.osp.spyglass.service.http.ScienceAppServiceSoap}.
 *
 * @author Jerry H. Seo
 * @see com.osp.spyglass.service.http.ScienceAppServiceSoap
 * @generated
 */
@ProviderType
public class ScienceAppSoap implements Serializable {
	public static ScienceAppSoap toSoapModel(ScienceApp model) {
		...
		soapModel.setRegisterStage(model.getRegisterStage());
