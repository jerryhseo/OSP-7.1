 ...
 * @see com.osp.spyglass.service.persistence.impl.LogPortsPersistenceImpl
 * @generated
 */
@ProviderType
public class LogPortsUtil {
	...
	*/
	public static LogPorts remove(long scienceAppId)
		throws com.osp.spyglass.exception.NoSuchLogPortsException {
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(LogPortsPersistence.class);

		ServiceTracker<LogPortsPersistence, LogPortsPersistence> serviceTracker = new ServiceTracker<LogPortsPersistence, LogPortsPersistence>(bundle.getBundleContext(),
				LogPortsPersistence.class, null);
