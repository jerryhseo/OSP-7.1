...
/**
 * Provides the local service interface for LogPorts. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Jerry H. Seo
 * @see LogPortsLocalServiceUtil
...
public interface LogPortsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LogPortsLocalServiceUtil} to access the log ports local service. Add custom service methods to {@link com.osp.spyglass.service.impl.LogPortsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
