 ...
 * @see com.osp.spyglass.service.persistence.impl.InputPortsPersistenceImpl
 * @generated
 */
@ProviderType
public class InputPortsUtil {
	...
	*/
	public static InputPorts remove(long scienceAppId)
		throws com.osp.spyglass.exception.NoSuchInputPortsException {
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(InputPortsPersistence.class);

		ServiceTracker<InputPortsPersistence, InputPortsPersistence> serviceTracker =
			new ServiceTracker<InputPortsPersistence, InputPortsPersistence>(bundle.getBundleContext(),
				InputPortsPersistence.class, null);
