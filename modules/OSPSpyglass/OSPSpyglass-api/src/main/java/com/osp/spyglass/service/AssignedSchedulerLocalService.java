...
/**
 * Provides the local service interface for AssignedScheduler. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Jerry H. Seo
 * @see AssignedSchedulerLocalServiceUtil
...
public interface AssignedSchedulerLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AssignedSchedulerLocalServiceUtil} to access the assigned scheduler local service. Add custom service methods to {@link com.osp.spyglass.service.impl.AssignedSchedulerLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public AssignedScheduler addAssignedScheduler(
	...
	*/
	...
	public AssignedScheduler createAssignedScheduler(long scienceAppId);
	...
	*/
	...
	public AssignedScheduler deleteAssignedScheduler(
		AssignedScheduler assignedScheduler);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public AssignedScheduler deleteAssignedScheduler(long scienceAppId)
	...
	*/
	...
	public AssignedScheduler fetchAssignedScheduler(long scienceAppId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AssignedScheduler getAssignedScheduler(long scienceAppId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AssignedScheduler> getAssignedSchedulers(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public AssignedScheduler updateAssignedScheduler(
		AssignedScheduler assignedScheduler);
}