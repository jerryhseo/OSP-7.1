...
/**
 * Provides the local service interface for OutputPorts. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see OutputPortsLocalServiceUtil
 * @see com.kisti.osp.spyglass.service.base.OutputPortsLocalServiceBaseImpl
 * @see com.kisti.osp.spyglass.service.impl.OutputPortsLocalServiceImpl
 * @generated
 */
@ProviderType
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface OutputPortsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OutputPortsLocalServiceUtil} to access the output ports local service. Add custom service methods to {@link com.kisti.osp.spyglass.service.impl.OutputPortsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public OutputPorts addOutputPorts(OutputPorts outputPorts);

	public OutputPorts addOutputPorts(long scienceAppId,
	...
	*/
	public OutputPorts createOutputPorts(long scienceAppId);
	...
	*/
	...
	public OutputPorts deleteOutputPorts(OutputPorts outputPorts);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public OutputPorts deleteOutputPorts(long scienceAppId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OutputPorts fetchOutputPorts(long scienceAppId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OutputPorts getOutputPorts(long scienceAppId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public OutputPorts updateOutputPorts(OutputPorts outputPorts);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OutputPorts> getOutputPortses(int start, int end);
