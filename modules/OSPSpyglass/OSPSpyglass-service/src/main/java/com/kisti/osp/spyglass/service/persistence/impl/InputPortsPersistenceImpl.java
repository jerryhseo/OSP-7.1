...
import com.kisti.osp.spyglass.model.impl.InputPortsImpl;
import com.kisti.osp.spyglass.model.impl.InputPortsModelImpl;
 ...
 * @see com.kisti.osp.spyglass.service.persistence.InputPortsUtil
 * @generated
 */
@ProviderType
public class InputPortsPersistenceImpl extends BasePersistenceImpl<InputPorts>
	...
	protected InputPorts removeImpl(InputPorts inputPorts) {
		inputPorts = toUnwrappedModel(inputPorts);
	...
	protected InputPorts toUnwrappedModel(InputPorts inputPorts) {
		if (inputPorts instanceof InputPortsImpl) {
			return inputPorts;
		}

		InputPortsImpl inputPortsImpl = new InputPortsImpl();

		inputPortsImpl.setNew(inputPorts.isNew());
		inputPortsImpl.setPrimaryKey(inputPorts.getPrimaryKey());

		inputPortsImpl.setScienceAppId(inputPorts.getScienceAppId());
		inputPortsImpl.setInputPorts(inputPorts.getInputPorts());
