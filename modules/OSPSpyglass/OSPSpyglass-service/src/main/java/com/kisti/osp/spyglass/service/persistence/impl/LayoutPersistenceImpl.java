...
import com.kisti.osp.spyglass.model.impl.LayoutImpl;
import com.kisti.osp.spyglass.model.impl.LayoutModelImpl;
 ...
 * @see com.kisti.osp.spyglass.service.persistence.LayoutUtil
 * @generated
 */
@ProviderType
public class LayoutPersistenceImpl extends BasePersistenceImpl<Layout>
	...
	protected Layout toUnwrappedModel(Layout layout) {
		...
		layoutImpl.setScienceAppId(layout.getScienceAppId());
		layoutImpl.setLayout(layout.getLayout());
