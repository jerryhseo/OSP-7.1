...
import com.kisti.osp.spyglass.model.impl.LogPortsImpl;
import com.kisti.osp.spyglass.model.impl.LogPortsModelImpl;
 ...
 * @see com.kisti.osp.spyglass.service.persistence.LogPortsUtil
 * @generated
 */
@ProviderType
public class LogPortsPersistenceImpl extends BasePersistenceImpl<LogPorts>
	...
	protected LogPorts removeImpl(LogPorts logPorts) {
		logPorts = toUnwrappedModel(logPorts);
	...
	protected LogPorts toUnwrappedModel(LogPorts logPorts) {
		if (logPorts instanceof LogPortsImpl) {
			return logPorts;
		}

		LogPortsImpl logPortsImpl = new LogPortsImpl();

		logPortsImpl.setNew(logPorts.isNew());
		logPortsImpl.setPrimaryKey(logPorts.getPrimaryKey());

		logPortsImpl.setScienceAppId(logPorts.getScienceAppId());
		logPortsImpl.setLogPorts(logPorts.getLogPorts());
