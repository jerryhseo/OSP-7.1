...
import com.kisti.osp.spyglass.model.impl.OutputPortsImpl;
import com.kisti.osp.spyglass.model.impl.OutputPortsModelImpl;
 ...
 * @see com.kisti.osp.spyglass.service.persistence.OutputPortsUtil
 * @generated
 */
@ProviderType
public class OutputPortsPersistenceImpl extends BasePersistenceImpl<OutputPorts>
	...
	protected OutputPorts removeImpl(OutputPorts outputPorts) {
		outputPorts = toUnwrappedModel(outputPorts);
	...
	protected OutputPorts toUnwrappedModel(OutputPorts outputPorts) {
		if (outputPorts instanceof OutputPortsImpl) {
			return outputPorts;
		}

		OutputPortsImpl outputPortsImpl = new OutputPortsImpl();

		outputPortsImpl.setNew(outputPorts.isNew());
		outputPortsImpl.setPrimaryKey(outputPorts.getPrimaryKey());

		outputPortsImpl.setScienceAppId(outputPorts.getScienceAppId());
		outputPortsImpl.setOutputPorts(outputPorts.getOutputPorts());
