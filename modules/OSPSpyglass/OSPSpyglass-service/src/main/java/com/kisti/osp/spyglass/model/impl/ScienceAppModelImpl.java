...
public class ScienceAppModelImpl extends BaseModelImpl<ScienceApp>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("parallelModule", Types.VARCHAR);
	...
	public static final long LANGUAGES_COLUMN_BITMASK = 16L;
	public static final long NAME_COLUMN_BITMASK = 32L;
	public static final long OPENLEVEL_COLUMN_BITMASK = 64L;
	public static final long RUNTYPE_COLUMN_BITMASK = 128L;
	public static final long STAGE_COLUMN_BITMASK = 256L;
	...
	public static ScienceApp toModel(ScienceAppSoap soapModel) {
		...
		model.setLanguages(soapModel.getLanguages());
	...
	public void setLanguages(String languages) {
		_columnBitmask |= LANGUAGES_COLUMN_BITMASK;

		if (_originalLanguages == null) {
	...
	public String getOriginalLanguages() {
		return GetterUtil.getString(_originalLanguages);
	}
	...
	public Object clone() {
		...
		scienceAppImpl.setLanguages(getLanguages());
	...
	public void resetOriginalValues() {
		...
		scienceAppModelImpl._originalLanguages = scienceAppModelImpl._languages;
	...
	public CacheModel<ScienceApp> toCacheModel() {
		...
		scienceAppCacheModel.languages = getLanguages();

		String languages = scienceAppCacheModel.languages;

		if ((languages != null) && (languages.length() == 0)) {
			scienceAppCacheModel.languages = null;
		}
	...
	public String toXmlString() {
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>languages</column-name><column-value><![CDATA[");
		sb.append(getLanguages());
		sb.append("]]></column-value></column>");
