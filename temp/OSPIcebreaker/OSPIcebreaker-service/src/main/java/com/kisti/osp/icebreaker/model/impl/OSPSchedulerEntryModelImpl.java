...
public class OSPSchedulerEntryModelImpl extends BaseModelImpl<OSPSchedulerEntry>
	...
	public Object clone() {
		...
		ospSchedulerEntryImpl.setUserName(getUserName());
		...
		ospSchedulerEntryImpl.setStatusByUserId(getStatusByUserId());
		ospSchedulerEntryImpl.setStatusByUserName(getStatusByUserName());
		ospSchedulerEntryImpl.setStatusDate(getStatusDate());
	...
	public CacheModel<OSPSchedulerEntry> toCacheModel() {
		...
		ospSchedulerEntryCacheModel.userName = getUserName();

		String userName = ospSchedulerEntryCacheModel.userName;

		if ((userName != null) && (userName.length() == 0)) {
			ospSchedulerEntryCacheModel.userName = null;
		}
		...
		ospSchedulerEntryCacheModel.statusByUserId = getStatusByUserId();

		ospSchedulerEntryCacheModel.statusByUserName = getStatusByUserName();

		String statusByUserName = ospSchedulerEntryCacheModel.statusByUserName;

		if ((statusByUserName != null) && (statusByUserName.length() == 0)) {
			ospSchedulerEntryCacheModel.statusByUserName = null;
		}

		Date statusDate = getStatusDate();

		if (statusDate != null) {
			ospSchedulerEntryCacheModel.statusDate = statusDate.getTime();
		}
		else {
			ospSchedulerEntryCacheModel.statusDate = Long.MIN_VALUE;
		}
	...
	private static final Class<?>[] _escapedModelInterfaces = new Class[] {
			OSPSchedulerEntry.class, ModelWrapper.class
		};
