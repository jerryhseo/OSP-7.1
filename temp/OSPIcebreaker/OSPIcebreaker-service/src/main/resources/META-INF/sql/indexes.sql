...
create index IX_D073211B on icebreaker_Job (groupId, simulationId);
...
create index IX_2794AC7E on icebreaker_OSPSchedulerEntry (name[$COLUMN_LENGTH:75$], version[$COLUMN_LENGTH:75$]);
