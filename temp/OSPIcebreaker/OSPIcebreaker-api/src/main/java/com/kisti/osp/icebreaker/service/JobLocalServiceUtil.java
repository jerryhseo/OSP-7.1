...
public class JobLocalServiceUtil {
	...
	*/
	...
	static {
		...
		ServiceTracker<JobLocalService, JobLocalService> serviceTracker = new ServiceTracker<JobLocalService, JobLocalService>(bundle.getBundleContext(),
				JobLocalService.class, null);
