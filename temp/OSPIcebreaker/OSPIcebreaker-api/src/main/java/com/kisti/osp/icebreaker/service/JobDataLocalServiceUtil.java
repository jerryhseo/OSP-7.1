...
public class JobDataLocalServiceUtil {
	...
	*/
	...
	static {
		...
		ServiceTracker<JobDataLocalService, JobDataLocalService> serviceTracker = new ServiceTracker<JobDataLocalService, JobDataLocalService>(bundle.getBundleContext(),
				JobDataLocalService.class, null);
