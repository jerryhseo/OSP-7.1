package com.kisti.osp.util.constants;
...
public class OSPPropertyKeys {
	...
	public static final String OSP_SERVER_USER_GROUP="osp.server.user.group";
	...
	public static final String getServerUserGroup(){
		return PropsUtil.get(OSP_SERVER_USER_GROUP);
	}
}
